...
Route::prefix('b_e')->group(function () {
    ...
    Route::apiResource("vin/postulacions2empre", InteraccionesEmprendimientos2Controller::class);
    ...
    Route::middleware('auth:api')->group(function () {
        ...
        Route::delete('vin/seguiformularioelim/{id}', [SeguiFormularioController::class, 'destroy']);
        Route::get('vin/ver_rep/{id}', [SeguiEncuestaController::class, 'ver_rep']);
        Route::get('vin/verificar_usuario_encuesta/{id}', [SeguiEncuestaController::class, 'verificar_usuario_encuesta']);
