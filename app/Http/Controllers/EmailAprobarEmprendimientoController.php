...
use App\Mail\AceptacionEmprendimiento;
class EmailAprobarEmprendimientoController extends Controller
{
    //
    //public function sendEmail(Request $request)
    public function enviaraprobarEmprendimiento(Request $request)
        {
            ...
            try {
                ...
                Mail::to($correoDestino)->send(new AceptacionEmprendimiento($nombreUsuario, $nombreEmprendimiento));
